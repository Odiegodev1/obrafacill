...
import { atualizarStatusObra, pegarStatusObra } from "@/app/(obrafacil)/adm/orcamento/actions/get-status";
import { SpinnerDemo } from "@/app/(obrafacil)/adm/orcamento/[publicId]/components/snpinnerp";
import { SelectorDemo } from "@/app/(obrafacil)/adm/orcamento/[publicId]/components/selector";
...
export function Statuss({ obraId }: StatusAppProps) {

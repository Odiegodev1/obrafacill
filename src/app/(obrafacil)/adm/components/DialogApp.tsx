...
import { Locate, PhoneCall, User, View } from "lucide-react";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Button } from "@/components/ui/button";

import { FormOrcamento } from "./neworc/formorcamento";
import CopiarLinkBotao from "./CopiarLinkBotao";

import { FotosObra } from "../orcamento/[publicId]/components/foto";
import { Statuss } from "@/components/status";
import Orcamento_mao from "../../orcamento/page";
...
export function DialogApp({ obra }: ObraDialogProps) {
  ...
  const linkPublico = `${process.env.NEXT_PUBLIC_SITE_URL}/adm/orcamento/${obra.publicId}`;
  return (
    <>
      <Dialog>
        <div className="flex items-center justify-end mb-2">
          ...
          <CopiarLinkBotao link={linkPublico} />
        </div>
